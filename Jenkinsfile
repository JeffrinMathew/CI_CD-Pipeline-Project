                ...
                script{
                    ...
                    [
                        [
                            ...
                            , credentialsId: 'nexus-auth', groupId: 'com.example', nexusUrl: 'localhost:9191', nexusVersion: 'nexus3', protocol: 'http', repository: 'http://localhost:9191/repository/Application_1_Release/', version: '1.0.0'
                }
            }
        }
